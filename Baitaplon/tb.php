                        ...
                        <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                            ...
                            <li class="nav-item dropdown ">
                                ...
                                <div class="dropdown-menu color" aria-labelledby="dropdownId">
                                    <a class="dropdown-item" href="dhcq.html" style="color: whitesmoke;">Đại học chính quy</a>
                                    <a class="dropdown-item" href="cdcq.html" style="color: whitesmoke;">Cao đẳng chính quy</a>
                                </div>
                            </li>
                            <li class="nav-item dropdown ">
